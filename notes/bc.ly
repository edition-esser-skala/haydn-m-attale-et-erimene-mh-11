...
MorereBassFigures = \figuremode {
  ...
  <_->
  <8>4 <7>8
  <5->4 \once \bassFigureExtendersOn q8 %65
  r4.
  <6! 5->
  r
  <6>4 <5->8
  ...
  <5-> <6- 4> <6>
  <6 _-> <6- 4> <5 _!>
  <_-> <5 _!>8. \once \bassFigureExtendersOn q16 %150
  <_->4 <\t>8
  <5-> <6- 4> <6>
  <6 _-> <6- 4> <5 -!>
  <_->4.
